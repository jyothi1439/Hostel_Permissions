...
<div class="col"><li class="nav-item "><a class="nav-link text-white" href="">View Requests</a></li></div>
</div>
</nav>
</nav>
...
PreparedStatement ps=con.prepareStatement("select * from request_outong where wardenapp='pending' and adminapp='accepted'");
...
<td><a href="Wardenaccept.jsp?rid=<%=rs.getString("regdno") %>">Accept</a><a href="reject.jsp?rid=<%=rs.getString("regdno") %>">Reject</a></td>
